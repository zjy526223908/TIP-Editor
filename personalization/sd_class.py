...
class ClassStableDiffusionImg2ImgPipeline(StableDiffusionImg2ImgPipeline):
    @torch.no_grad()
    ...
    def __call__(
            ...
            strength: float = 0.8,
            class_labels: torch.FloatTensor = None,
...
class ClassStableDiffusionPipeline(StableDiffusionPipeline):
    @torch.no_grad()
    @replace_example_docstring(EXAMPLE_DOC_STRING)
    def __call__(
            self,
